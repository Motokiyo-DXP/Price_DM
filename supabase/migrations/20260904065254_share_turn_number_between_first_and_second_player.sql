...
begin
  ...
  if p_state ->> 'activePlayer' is distinct from v_before_state ->> 'activePlayer'
     and (
       (v_before_state ->> 'activePlayer' = 'p1'
        and p_state ->> 'activePlayer' = 'p2'
        and coalesce((p_state ->> 'turn')::integer, v_turn_number) = v_turn_number)
       or
       (v_before_state ->> 'activePlayer' = 'p2'
        and p_state ->> 'activePlayer' = 'p1'
        and coalesce((p_state ->> 'turn')::integer, v_turn_number) = v_turn_number + 1)
     ) then
