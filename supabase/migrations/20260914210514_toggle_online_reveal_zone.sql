...
begin
  ...
  v_result := pg_catalog.jsonb_set(v_result,'{revealPublic}',pg_catalog.jsonb_build_object(
    'p1',coalesce(p_submitted #> '{revealPublic,p1}' = 'true'::jsonb,false),
    'p2',coalesce(p_submitted #> '{revealPublic,p2}' = 'true'::jsonb,false)),true);
  return v_result;
end;
$$;
