...
export default async function OnlineBattlePage({ params }: { params: Promise<{ roomId: string }> }) {
  ...
  const [{ data: room, error: roomError }, { data: roomState, error: stateError }, { data: deckLabels }, { data: matchSlot }] = await Promise.all([
